...
open class MaterialShowcase: UIView {
    ...
    public var skipButtonImage = "HintClose" {
        didSet { skipButtonType = .image }
    }
    public var skipButtonTitle = "" {
        didSet { skipButtonType = .text }
    }
...
//    @objc public var targetHolderInitialScale: CGFloat = 1.0
    ...
    internal var targetHolderRadius: CGFloat {
        ...
        case .circle(let radius), .roundedRect(let radius):
            return radius
        default:
            return 0
        }
...
extension MaterialShowcase {
    ...
    public static func presentedShowcases() -> [MaterialShowcase]? {
        ...
        return window.subviews.compactMap { $0 as? MaterialShowcase }
    }
}
...
extension MaterialShowcase {
    ...
    func setDefaultProperties() {
        ...
        targetHolderStyle = .circle(radius: TARGET_HOLDER_RADIUS)
        // Text
    ...
    private func addBackground() {
        ...
        addBackgroundMask(in: backgroundView)
    }
...
//  private func addBackgroundMask(with radius: CGFloat, in view: UIView) {
    private func addBackgroundMask(in view: UIView) {
    ...
    private func addTarget(at center: CGPoint) {
        ...
        if shouldSetTintColor {
            ...
            if let button = targetView as? UIButton, let buttonCopy = targetCopyView as? UIButton {
